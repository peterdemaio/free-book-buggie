...
router.get('/', (req, res) => {
    const queryText = `SELECT "contacts".id, "contacts".name, "contacts".phone_number, "contacts".phone_number_type, "contacts".email, "contacts".notes, "organizations".org_name FROM "contacts"
